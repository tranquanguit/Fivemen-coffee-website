...
{
    public partial class FivemenCoffeeContext : DbContext
    {
        public FivemenCoffeeContext()
        {
        }
        public FivemenCoffeeContext(DbContextOptions<FivemenCoffeeContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=localhost;Database=FivemenCoffee;Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Roles>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__ROLE__8AFACE3AD1F8A3B2");
